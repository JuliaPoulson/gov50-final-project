...
knitr::kable(p_val)
```
The hypothesis test reveals that there is a 97% chance that this correlation value could have been created by random chance in a world in which the two values have absolutely no correlation. Given this, we can certainly not reject the null hypothesis, and instead likely should accept it as the most likely outcome of the analysis.
